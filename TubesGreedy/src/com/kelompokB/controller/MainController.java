...
//        activities.add(new Activity("A9",LocalTime.of(8,0), LocalTime.of(12,0)));
        ...
        activities.add(new Activity("A1",LocalTime.of(9,0), LocalTime.of(12,0)));
        activities.add(new Activity("A2",LocalTime.of(7,0), LocalTime.of(14,0)));
        activities.add(new Activity("A3",LocalTime.of(7,0), LocalTime.of(9,0)));
        activities.add(new Activity("A4",LocalTime.of(13,0), LocalTime.of(15,0)));
        activities.add(new Activity("A5",LocalTime.of(9,0), LocalTime.of(12,0)));
        activities.add(new Activity("A6",LocalTime.of(15,0), LocalTime.of(19,0)));
        activities.add(new Activity("A7",LocalTime.of(8,0), LocalTime.of(12,0)));
        activities.add(new Activity("A8",LocalTime.of(12,0), LocalTime.of(16,0)));
        activities.add(new Activity("A9",LocalTime.of(3,0), LocalTime.of(9,0)));
        activities.add(new Activity("A10",LocalTime.of(10,0), LocalTime.of(19,0)));
        activities.add(new Activity("A11",LocalTime.of(19,0), LocalTime.of(21,0)));
        activities.add(new Activity("A12",LocalTime.of(5,0), LocalTime.of(7,0)));
        activities.add(new Activity("A13",LocalTime.of(8,0), LocalTime.of(11,0)));
        activities.add(new Activity("A14",LocalTime.of(5,0), LocalTime.of(9,0)));
        activities.add(new Activity("A15",LocalTime.of(1,0), LocalTime.of(4,0)));

        activities.add(new Activity("A1",LocalTime.of(9,30), LocalTime.of(12,45)));
        activities.add(new Activity("A2",LocalTime.of(7,15), LocalTime.of(14,45)));
        activities.add(new Activity("A3",LocalTime.of(12,0), LocalTime.of(16,0)));
        activities.add(new Activity("A4",LocalTime.of(13,0), LocalTime.of(15,0)));
        activities.add(new Activity("A5",LocalTime.of(9,30), LocalTime.of(12,0)));
        activities.add(new Activity("A6",LocalTime.of(13,0), LocalTime.of(14,0)));
        activities.add(new Activity("A7",LocalTime.of(8,45), LocalTime.of(12,45)));
        activities.add(new Activity("A8",LocalTime.of(12,0), LocalTime.of(15,0)));
        activities.add(new Activity("A9",LocalTime.of(9,0), LocalTime.of(13,0)));
        activities.add(new Activity("A10",LocalTime.of(9,0), LocalTime.of(10,0)));
        activities.add(new Activity("A11",LocalTime.of(13,0), LocalTime.of(17,0)));
        activities.add(new Activity("A12",LocalTime.of(6,0), LocalTime.of(7,0)));
        activities.add(new Activity("A13",LocalTime.of(8,15), LocalTime.of(11,15)));
        activities.add(new Activity("A14",LocalTime.of(5,0), LocalTime.of(9,0)));
        activities.add(new Activity("A15",LocalTime.of(1,0), LocalTime.of(4,0)));
        activities.add(new Activity("A16",LocalTime.of(9,0), LocalTime.of(1,0)));
        activities.add(new Activity("A17",LocalTime.of(8,0), LocalTime.of(12,0)));
        activities.add(new Activity("A18",LocalTime.of(12,0), LocalTime.of(16,0)));
        activities.add(new Activity("A19",LocalTime.of(9,0), LocalTime.of(15,0)));
        activities.add(new Activity("A20",LocalTime.of(10,0), LocalTime.of(16,0)));
